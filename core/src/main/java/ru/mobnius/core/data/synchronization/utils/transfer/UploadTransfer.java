...
public class UploadTransfer extends Transfer {
    ...
    class UploadListener extends TransferListener {
         ...
         */
        public UploadListener(OnSynchronizationListeners synchronization, Activity activity, String tid, UploadTransfer instance, ITransferStatusCallback statusCallback) {
