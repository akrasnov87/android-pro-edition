...
import ru.mobnius.core.data.synchronization.meta.TableQuery;
...
public abstract class FileTransferWebSocketSynchronization
     ...
     */
    public FileTransferWebSocketSynchronization(Context context, AbstractDaoSession session, String name, FileManager fileManager, boolean zip) {
        super(context, session, name, zip);
