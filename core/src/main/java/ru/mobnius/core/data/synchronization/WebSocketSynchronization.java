...
import ru.mobnius.core.data.synchronization.utils.transfer.ITransferStatusCallback;
...
public abstract class WebSocketSynchronization extends BaseSynchronization {
     ...
     * @param name имя
     */
    public WebSocketSynchronization(Context context, AbstractDaoSession session, String name, boolean zip) {
