...
import ru.mobnius.core.data.synchronization.utils.IServerSidePackage;
...
public abstract class BaseSynchronization implements OnSynchronizationListeners {
     ...
     */
    protected BaseSynchronization(Context context, AbstractDaoSession session, String name, boolean zip) {
        mContext = context;
