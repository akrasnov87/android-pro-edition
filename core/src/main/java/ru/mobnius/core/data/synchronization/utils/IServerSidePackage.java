...
public interface IServerSidePackage {
     ...
     * @return результат
     */
    PackageResult to(AbstractDaoSession session, RPCResult rpcResult, String packageTid);
     ...
     * @return результат
     */
    PackageResult to(AbstractDaoSession session, RPCResult rpcResult, String packageTid, Boolean clearable);
     ...
     * @return результат
     */
    PackageResult from(AbstractDaoSession session, RPCResult rpcResult, String packageTid, boolean isRequestToServer, boolean attachmentUse) throws JSONException;
}
