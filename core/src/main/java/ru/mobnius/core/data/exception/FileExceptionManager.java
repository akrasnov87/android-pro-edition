...
import ru.mobnius.core.utils.FileUtil;
...
public class FileExceptionManager implements IExceptionManager, IFileExceptionManager {
     ...
     */
    protected boolean deleteRecursive(File fileOrDirectory) {
    ...
    public List<ExceptionModel> getExceptionList() {
        ...
        if(files != null) {
            ...
            for (String fileName : files) {
                ...
                if (bytes != null) {
                    ExceptionModel model = ExceptionModel.toModel(new String(bytes));
                    if (model != null) {
                        list.add(model);
                    }
                }
