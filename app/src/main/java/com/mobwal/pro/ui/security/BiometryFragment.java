...
public class BiometryFragment extends BaseFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LogManager.getInstance().info("Безопасность. Пин-код.");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBinding.securityReset.setOnClickListener(v -> {
            ...
            builder.setPositiveButton(R.string.yes, (dialog, which) -> {
                LogManager.getInstance().debug("Пользователь принудительно сбрасывает ПИН-код.");
    ...
    private void onAuthorized() {
        LogManager.getInstance().debug("Авторизация по ПИН-коду выполнена");
